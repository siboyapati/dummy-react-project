...
userSchema.methods.toJSON = function () {
  ...
  const avatar = (0, _utils.isValidUrl)(this.avatar) ? this.avatar : _fs.default.existsSync(absoluteAvatarFilePath) ? `${process.env.IMAGES_FOLDER_PATH}${this.avatar}` : `${process.env.IMAGES_FOLDER_PATH}avatar2.jpg`;
  return {
    id: this._id,
